% The 'weights' function for calculating finite difference stencils
% (away from interfaces) was generously contributed by Professor Bengt ...
% Fornberg at the University of Colorado, Boulder (fornberg@colorado.edu).
